...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const studentData = {
        name: 'Pedro Antonio Leon Reyes',
        code: 'U23246461',
        career: 'Ingeniería de Sistemas e informática',
        location: 'Chimbote, Perú',
        links: {
            github: 'https://github.com/programer-04',
            linkedin: 'https://linkedin.com/in/usuario',
            portfolio: './portafolio/index.html',
            email: 'mailto:u20201234@utp.edu.pe',
            cv: 'documents/cv.pdf',
            instagram: 'https://www.instagram.com/pedro_leoncitorey?igsh=MWlmOGljeDAwYnBtZg%3D%3D&utm_source=qr'
        }
    };
    ...
    function updateStudentInfo() {
        ...
        const locationElement = document.getElementById('studentlocation')
